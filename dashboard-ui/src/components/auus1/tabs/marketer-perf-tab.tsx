            ...
            try {
                ...
                const queries = [
                    ...
                    `SELECT
                        ...
                        ROUND(SUM(revenue_prov_70),0) as revenue,
                        ROUND(SUM(ads_spend_ron),0) as ads_spend,
                        0 as shipping,
                        ROUND(SUM(cogs),0) as cogs,
                        ROUND(SUM(revenue_prov_70) - SUM(ads_spend_ron) - SUM(cogs),0) as net_profit,
                        ROUND(SAFE_DIVIDE(SUM(revenue_prov_70), NULLIF(SUM(ads_spend_ron),0)),2) as roas,
