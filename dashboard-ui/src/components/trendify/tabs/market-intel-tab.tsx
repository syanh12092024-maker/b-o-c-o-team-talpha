            ...
            try {
                ...
                const queries = [
                    ...
                    `SELECT
                        ...
                        0 as cogs,
                        ROUND(SUM(revenue_success),0) as gross_profit,
                        ROUND(SAFE_DIVIDE(SUM(revenue_success) - SUM(ads_spend_ron), NULLIF(SUM(revenue_success),0)) * 100, 1) as margin,
                    ...
                    WHERE report_date BETWEEN '${from}' AND '${to}'
                        AND market_code IN ('RO','US','HR','IT','BG')
